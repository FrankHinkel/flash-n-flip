...
| Missbrauch des öffentlichen Verbindungsdienstes | ausschließlich STUN Binding auf UDP 3478, TURN ausdrücklich deaktiviert, kein Relay-Portbereich, kein Binding-Logging, gehärteter unprivilegierter Container            |
...
- STUN legt gegenüber dem Dienst die öffentliche Quelladresse des anfragenden
  Geräts offen. Der Dienst protokolliert Binding-Anfragen nicht und hält keinen
  sitzungsbezogenen Zustand; die Information wird nur als direkter ICE-
  Kandidat an das beteiligte Gerät zurückgegeben.
