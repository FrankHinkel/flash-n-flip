...
const copy = {
  de: {
    title: "iCloud-Synchronisierung", notice: "Nach deiner Freigabe werden Decks, Karten, Medien und Lernfortschritte in deiner privaten iCloud gespeichert. Pro Karte gewinnt die zeitlich letzte Bewertung, nicht der letzte Upload. Einstellungen und Lernplaene bleiben auf diesem Geraet.",
    ...
    removeWarning: "Zuerst wird vollstaendig hochgeladen. Danach wird nur die lokale Deck-Kopie entfernt. Bewertungen und iCloud-Daten bleiben erhalten.",
  ...
  en: {
    title: "iCloud synchronization", notice: "After your approval, decks, cards, media and learning progress are stored in your private iCloud. Each card uses the latest actual review, not the latest upload. Settings and study plans remain on this device.",
    ...
    removeWarning: "A complete upload finishes first. Only the local deck copy is removed. Reviews and iCloud data are retained.",
