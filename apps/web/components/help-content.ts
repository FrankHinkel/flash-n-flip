    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          {
            en: "Add shared options directly to the opening fence, for example ```music{size=70 w=100% h=50vh bg=auto bars=auto select=RH keyboard=notes finger=off}. size accepts 25–300 with or without %; bars accepts auto or 1 to 12 measures per line; select shows and plays only the named ABC voice; finger=off hides numeric fingerings without removing them from the ABC source.",
            de: "Ergänze die gemeinsamen Optionen direkt am öffnenden Zaun, zum Beispiel ```music{size=70 w=100% h=50vh bg=auto bars=auto select=RH keyboard=notes finger=off}. size akzeptiert 25–300 mit oder ohne %; bars akzeptiert auto oder 1 bis 12 Takte pro Zeile; select zeigt und spielt nur die benannte ABC-Stimme; finger=off blendet numerische Fingersätze aus, ohne sie aus der ABC-Quelle zu entfernen.",
            es: "Añade opciones compartidas directamente a la valla de apertura, por ejemplo ```music{size=70 w=100% h=50vh bg=auto bars=auto select=RH keyboard=notes finger=off}. size acepta 25–300 con o sin %; bars acepta auto o de 1 a 12 compases por línea; select muestra y reproduce solo la voz ABC indicada; finger=off oculta la digitación numérica sin eliminarla de la fuente ABC.",
            fr: "Ajoutez les options partagées directement à l'enceinte d'ouverture, par exemple ```music{size=70 w=100% h=50vh bg=auto bars=auto select=RH keyboard=notes finger=off}. size accepte 25–300 avec ou sans % ; bars accepte auto ou de 1 à 12 mesures par ligne ; select affiche et joue uniquement la voix ABC indiquée ; finger=off masque les doigtés numériques sans les supprimer de la source ABC.",
          },
        ],
      },
      {
