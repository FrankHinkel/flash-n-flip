...
export function LanguageSwitcher() {
  ...
  return (
    <div
      className="admin-preference-switchers"
      aria-label={text("Language and appearance", "Sprache und Darstellung")}
      ref={root}
    >
      <div className="admin-preference-popup">
        <button
          ...
          className="admin-preference-trigger"
          onClick={() =>
        ...
        {popup === "language" && (
          <div
            className="admin-preference-menu"
            role="menu"
      ...
      <div className="admin-preference-popup">
        ...
        {popup === "theme" && (
          <div
            className="admin-preference-menu admin-theme-menu"
            role="menu"
