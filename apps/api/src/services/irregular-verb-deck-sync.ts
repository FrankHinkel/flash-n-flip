...
import { createIrregularVerbDeckSeeds } from "./irregular-verb-deck.js";

export type IrregularVerbDeckSyncResult = {
  createdDeckCount: number;
  idsByKey: Map<string, string>;
};

export async function syncIrregularVerbDecksForOwner(
  db: typeof database,
  ownerId: string,
  options: {
...
): Promise<IrregularVerbDeckSyncResult> {
