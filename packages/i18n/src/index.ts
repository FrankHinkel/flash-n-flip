...
const semanticUiMessages = {
  ...
  "catalog.periodicTable.eyebrow": {
    en: "Chemistry",
    de: "Chemie",
    es: "Química",
    fr: "Chimie",
  },
  "catalog.periodicTable.cards": {
    en: "{0} reference cards · {1} German learning cards",
    de: "{0} Referenzkarten · {1} deutschsprachige Lernkarten",
    es: "{0} tarjetas de referencia · {1} tarjetas didácticas en alemán",
    fr: "{0} cartes de référence · {1} cartes d’apprentissage en allemand",
  },
  "catalog.periodicTable.install": {
    en: "Install periodic-table collection",
    de: "Periodensystem-Sammlung installieren",
    es: "Instalar la colección de la tabla periódica",
    fr: "Installer la collection du tableau périodique",
  },
  "catalog.periodicTable.open": {
    en: "Open periodic-table collection",
    de: "Periodensystem-Sammlung öffnen",
    es: "Abrir la colección de la tabla periódica",
    fr: "Ouvrir la collection du tableau périodique",
  },
  "catalog.periodicTable.installing": {
    en: "Installing periodic-table collection…",
    de: "Periodensystem-Sammlung wird installiert…",
    es: "Instalando la colección de la tabla periódica…",
    fr: "Installation de la collection du tableau périodique…",
  },
  "catalog.installPeriodicTableFailed": {
    en: "The periodic-table collection could not be installed.",
    de: "Die Periodensystem-Sammlung konnte nicht installiert werden.",
    es: "No se pudo instalar la colección de la tabla periódica.",
    fr: "La collection du tableau périodique n’a pas pu être installée.",
  },
  "study.rating.again": {
    en: "Again",
    de: "Nochmal",
  ...
  "rich.periodicTable.select": {
    en: "Select element",
    de: "Element auswählen",
    es: "Seleccionar elemento",
    fr: "Sélectionner un élément",
  },
  "rich.periodicTable.previous": {
    en: "Previous element",
    de: "Vorheriges Element",
    es: "Elemento anterior",
    fr: "Élément précédent",
  },
  "rich.periodicTable.next": {
    en: "Next element",
    de: "Nächstes Element",
    es: "Elemento siguiente",
    fr: "Élément suivant",
  },
  "rich.periodicTable.atomicNumber": {
    en: "Atomic number",
    de: "Ordnungszahl",
    es: "Número atómico",
    fr: "Numéro atomique",
  },
  "rich.periodicTable.atomicMass": {
    en: "Atomic mass",
    de: "Atommasse",
    es: "Masa atómica",
    fr: "Masse atomique",
  },
  "rich.periodicTable.group": {
    en: "Group",
    de: "Gruppe",
    es: "Grupo",
    fr: "Groupe",
  },
  "rich.periodicTable.period": {
    en: "Period",
    de: "Periode",
    es: "Período",
    fr: "Période",
  },
  "rich.periodicTable.category": {
    en: "Category",
    de: "Kategorie",
    es: "Categoría",
    fr: "Catégorie",
  },
  "rich.periodicTable.electronConfiguration": {
    en: "Electron configuration",
    de: "Elektronenkonfiguration",
    es: "Configuración electrónica",
    fr: "Configuration électronique",
  },
  "rich.periodicTable.electronegativity": {
    en: "Electronegativity",
    de: "Elektronegativität",
    es: "Electronegatividad",
    fr: "Électronégativité",
  },
  "rich.periodicTable.standardState": {
    en: "Standard state",
    de: "Aggregatzustand",
    es: "Estado estándar",
    fr: "État standard",
  },
  "rich.periodicTable.discovered": {
    en: "Discovered",
    de: "Entdeckt",
    es: "Descubierto",
    fr: "Découvert",
  },
  "rich.periodicTable.fBlock": {
    en: "f-block",
    de: "f-Block",
    es: "bloque f",
    fr: "bloc f",
  },
  "rich.periodicTable.failed": {
    en: "The periodic table could not be rendered safely.",
    de: "Das Periodensystem konnte nicht sicher gerendert werden.",
    es: "La tabla periódica no se pudo renderizar de forma segura.",
    fr: "Le tableau périodique n’a pas pu être rendu de manière sûre.",
  },
